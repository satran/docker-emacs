;;; plain-white-theme.el - A minimalistic Emacs 24 theme
...
(autothemer-deftheme
 ...
 ((default (:background background :foreground foreground))
   ...
   (isearch (:foreground background :background region))
   (isearch-fail (:foreground failure))
   (lazy-highlight (:foreground background :background region))
   ...
   ;; show-paren
   (show-paren-match (:background region :foreground background))
   ...
   (org-table (:background org-background))
   (org-code (:background org-background))
   (org-date (:background org-background :underline t))
   (org-block (:background org-background))
   (org-block-background (:background org-background :foreground foreground))
   (org-block-begin-line (:background org-background :foreground comment-delimiter))
   (org-block-end-line (:background org-background :foreground comment-delimiter))
   ...
   (erc-timestamp-face (:foreground erc-notice))
   (erc-notice-face (:foreground erc-notice))

   ;; Shell script mode
   (sh-quoted-exec (:foreground keyword))
  ...
  ;; helm
   ...
   (helm-candidate-number-suspended (:background background :foreground foreground))
 ...
 (custom-theme-set-variables 'plain-white
